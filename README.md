...
<strong> - Red Dashed Line</strong> = This is our threshold level/ default probability rate, the model uses this % probability to label a customer as churn vs. not churn.<br/>
