...
-   **85% Dection** = Model Predicted Churn , Customer Actually Churned <br/>
-   **34% False Alarms** = Model Predicted Churn , Customer Actually remained Loyal<br/>
-   **15% Undetected Churn** = Model Predicted Loyal , Customer Actually Churned<br/>
-   **Red Dashed Line** = This is our threshold level/ default probablity rate on how our model labels a customer as churn vs. not churn<br/>
